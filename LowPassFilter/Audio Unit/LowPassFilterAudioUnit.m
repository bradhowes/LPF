...
#import "LowPassFilterAudioUnit.h"
...
@interface LowPassFilterAudioUnit ()
...
@implementation LowPassFilterAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[LowPassFilterDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block LowPassFilterDSPKernelAdapter * kernelAdapter = _kernelAdapter;
